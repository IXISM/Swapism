...
const MOCK_PRODUCTS: Product[] = [
  { id: '1', name: 'Jeans cool and baggy (fit)', image: 'https://picsum.photos/id/445/300/400', rating: 4.8, size: 'L', description: 'Vintage baggy jeans, barely worn. Super comfortable styling.', owner: 'Ben' },
  { id: '2', name: 'Vintage Jacket', image: 'https://picsum.photos/id/338/300/400', rating: 4.5, size: 'M', description: 'Classic 90s jacket.', owner: 'Lemmy' },
  { id: '3', name: 'Summer Dress', image: 'https://picsum.photos/id/64/300/400', rating: 5.0, size: 'S', description: 'Floral pattern summer dress.', owner: 'Jenny' },
  { id: '4', name: 'Cargo Pants', image: 'https://picsum.photos/id/177/300/400', rating: 4.2, size: 'XL', description: 'Utility cargo pants in khaki.', owner: 'Mike' },
];
...
const Splash: React.FC = () => {
  ...
  return (
    <div className="h-full w-full bg-swap-beige flex flex-col items-center justify-center relative overflow-hidden">
        {/* Abstract Hanger/Shape Logo Representation */}
        <div className="relative z-10 animate-fade-in">
            <div className="w-48 h-48 bg-swap-green rounded-full opacity-80 blur-xl absolute top-0 left-0 -translate-x-1/4 -translate-y-1/4"></div>
            <div className="relative z-20">
                <svg width="200" height="150" viewBox="0 0 200 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M100 20 C 130 20, 150 50, 180 80 L 20 80 C 50 50, 70 20, 100 20" stroke="#1e1e1e" strokeWidth="4" fill="none"/>
                    <text x="50%" y="120" textAnchor="middle" className="font-serif text-3xl font-bold fill-swap-dark" style={{letterSpacing: '0.1em'}}>SWAPISM</text>
                </svg>
            </div>
        </div>
    </div>
...
const Welcome: React.FC = () => {
  const navigate = useNavigate();
  return (
    <div className="h-full w-full bg-swap-light flex flex-col p-8 relative">
       {/* Background Illustrations */}
       <div className="absolute top-10 left-1/2 -translate-x-1/2 w-full max-w-[300px]">
          <div className="flex justify-center space-x-2 mb-4">
             <div className="w-8 h-1 bg-swap-dark rounded-full"></div> 
             <div className="w-16 h-16 rounded-full border-2 border-dashed border-swap-dark flex items-center justify-center">
                 <div className="w-12 h-1 text-xs text-center">Hanger</div>
             </div>
          </div>
          <img src="https://picsum.photos/id/836/300/200" alt="Friends" className="rounded-2xl shadow-lg mb-4 object-cover h-48 w-full" />
          <div className="flex justify-center space-x-4">
             <div className="w-12 h-24 bg-swap-green/50 rounded-full"></div>
             <div className="w-12 h-24 bg-swap-mustard/50 rounded-full"></div>
             <div className="w-12 h-24 bg-swap-rust/50 rounded-full"></div>
          </div>
       </div>

       <div className="mt-auto flex flex-col space-y-4 mb-8">
         <h1 className="text-4xl font-serif text-swap-dark text-center mb-2">Welcome!</h1>
         <p className="text-center text-gray-500 text-sm mb-6">Discover, swap, and try clothes virtually</p>
         
         <Button onClick={() => navigate('/login')}>Login</Button>
         <Button variant="outline" onClick={() => navigate('/register')}>Sign Up</Button>
         <button onClick={() => navigate('/home')} className="text-sm text-swap-rust font-medium text-center mt-4">Skip for now</button>
       </div>
    </div>
  );
};
  ...
  return (
    <div className="h-full w-full bg-swap-light flex flex-col p-8 pt-12">
      ...
      <div className="space-y-4">
        <input type="email" placeholder="Email" className="w-full p-4 rounded-xl bg-white border border-gray-200 focus:border-swap-green outline-none" />
        <input type="password" placeholder="Password" className="w-full p-4 rounded-xl bg-white border border-gray-200 focus:border-swap-green outline-none" />
        
        <Button fullWidth onClick={() => navigate('/home')}>Log In</Button>
...
const Register: React.FC = () => {
  ...
  return (
    <div className="h-full w-full bg-swap-light flex flex-col p-8 pt-12">
      ...
      <div className="space-y-4">
        <input type="text" placeholder="Username" className="w-full p-4 rounded-xl bg-white border border-gray-200 focus:border-swap-green outline-none" />
        <input type="email" placeholder="Email" className="w-full p-4 rounded-xl bg-white border border-gray-200 focus:border-swap-green outline-none" />
        <input type="password" placeholder="Password" className="w-full p-4 rounded-xl bg-white border border-gray-200 focus:border-swap-green outline-none" />
        
        <div className="flex items-center space-x-2 px-2">
            <div className="w-4 h-4 rounded-full border border-swap-green"></div>
            <span className="text-xs text-gray-500">I accept the T&C</span>
        </div>

        <Button fullWidth onClick={() => navigate('/home')}>Create Account</Button>
    ...
    return (
        <div className="bg-swap-light h-full pb-20 overflow-y-auto no-scrollbar">
            ...
            <div className="px-4 mt-4">
                ...
                {/* Mirror Button - Navigate to Mirror */}
                <div 
